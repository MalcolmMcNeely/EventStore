...
public class EventStreamFactory(AzureService azureService, Lazy<IEventTypeRegistration> eventTypeRegistration) : IEventStreamFactory
{
    ...
    public IEventStream For(string streamName)
    {
        ...
        return new EventStream(azureService, streamName, semaphoreSlim, eventTypeRegistration);
    }
}